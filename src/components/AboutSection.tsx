  ...
  return (
    <section id="about" className="section-padding">
      <div className="container-custom">
        ...
        {/* Company Details */}
        <div className="bg-muted rounded-xl p-6 mb-12 max-w-2xl mx-auto slide-up" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center slide-up" style={{ animationDelay: "0.4s" }}>
            <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden ring-4 ring-accent/20 shadow-xl">
              <img
                src={suryarajImage}
                alt="Suriyaraj - Managing Director"
                className="w-full h-full object-cover"
              />
            </div>
            <h4 className="text-xl font-bold text-foreground mb-1">Suriyaraj</h4>
            <p className="text-accent font-medium mb-3">Managing Director</p>
            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
